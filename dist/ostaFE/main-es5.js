(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AvailablelOstaComponent = /** @class */ (function () {
                function AvailablelOstaComponent(rout, user) {
                    this.rout = rout;
                    this.user = user;
                ...
                AvailablelOstaComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.rout.paramMap
                        .subscribe(function (params) {
                        _this.service = params.get('selected');
                    });
                    this.user.getCustomersList(this.service)
                        .subscribe(function (result) {
                        _this.avialableOsta = result;
                        console.log(result);
                    }, function (errors) {
                        console.log(errors);
                    });
                };
                return AvailablelOstaComponent;
            }());
            AvailablelOstaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BeOstaComponent = /** @class */ (function () {
                function BeOstaComponent(userservice, router) {
                    this.userservice = userservice;
                    this.router = router;
                }
                BeOstaComponent.prototype.submit = function (f) {
                    var _this = this;
                ...
                return BeOstaComponent;
            }());
            BeOstaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ConactUsComponent = /** @class */ (function () {
                function ConactUsComponent() {
                }
                ConactUsComponent.prototype.ngOnInit = function () {
                };
                return ConactUsComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.submit = function (f) {
                    ...
                    this.user.getUser({ "username": phone, "password": pass }).subscribe(function (data) {
                        if (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavBarComponent = /** @class */ (function () {
                ...
                NavBarComponent.prototype.checkosta = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/user.service */ "./src/app/services/user.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var OstaProfileComponent = /** @class */ (function () {
                function OstaProfileComponent(user, router) {
                    this.user = user;
                    this.router = router;
                }
                OstaProfileComponent.prototype.submit = function (f) {
                    var user = localStorage.getItem('user');
                    console.log(user);
                    this.user.chOsta({ "username": user }).subscribe(function (data) {
                    }, function (error) {
                        console.log(error);
                    });
                    this.router.navigate(['']);
                };
                return OstaProfileComponent;
            }());
            OstaProfileComponent.ctorParameters = function () { return [
                { type: _services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.getUser = function (obj) {
                    return this.http.post(this.baseUrl + "/customer/login", obj);
                };
                UserService.prototype.chOsta = function (obj) {
                ...
                UserService.prototype.getCustomersList = function (id) {
                    return this.http.get(this.baseUrl + "/customer/list/" + id + "/");
                };
                UserService.prototype.createOsta = function (osta) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                ...
                SignupComponent.prototype.submit = function (f) {
                    var _this = this;
